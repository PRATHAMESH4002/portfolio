        ...
        <section className="px-4 md:px-40 max-h-max min-h-screen pt-10 md:pt-20 bg-white dark:bg-slate-800 dark:text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
            ...
            transition={{duration:0.6, delay: 0.5}}className="border-2 border-gray-200 p-4 rounded-lg shadow-lg hover:bg-lightHover hover:-translate-y-1 
              ...
              <nav>
                <ul className="flex flex-col gap-2">
                  <li className="border border-green-500 p-2 rounded">Manual Testing</li>
                  <li className="border border-green-500 p-2 rounded">SDLC</li>
                  <li className="border border-green-500 p-2 rounded">STLC</li>
                  <li className="border border-green-500 p-2 rounded">Test Case Design</li>
                  <li className="border border-green-500 p-2 rounded">Bug Reporting</li>
                  <li className="border border-green-500 p-2 rounded">AGILE & SCRUM </li>
            ...
            <motion.div
             ...
             transition={{duration:0.6, delay: 0.5}} className="border-2 border-gray-200 p-4 rounded-lg shadow-lg hover:bg-lightHover hover:-translate-y-1 
              ...
              <nav>
                <ul className="flex flex-col gap-2">
                     <li className="border border-green-500 p-2 rounded">JIRA</li>
                 <li className="border border-green-500 p-2 rounded">Git</li>
                 
<li className="border border-green-500 p-2 rounded">GitHub</li>
<li className="border border-green-500 p-2 rounded">Postman</li>
<li className="border border-green-500 p-2 rounded">Vercel</li>
<li className="border border-green-500 p-2 rounded">Render</li>

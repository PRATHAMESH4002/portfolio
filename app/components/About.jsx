...
export default function About({ isDarkMode }) {
  return (
    ...
    transition={{duration:1}}>
      ...
      initial={{opacity:0}}
      whileInView={{opacity:1}}
      transition={{duration:0.8}} className="w-full flex flex-col lg:flex-row items-center gap-20 my-20">
        <motion.div
        ...
        transition={{duration:0.6, delay: 0.8}} className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am Prathamesh Dabhole, a BE Computer Engineering student
at Bharati Vidyapeeth College of Engineering, Lavale, Pune.

I specialize in MERN Stack Development and have built
real-world projects including a Job Portal,
Hotel Management System, Food Delivery App,
Weather App, and StrayCare Animal Rescue Platform.

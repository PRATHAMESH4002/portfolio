...
export default function Header() {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        md:text-2xl mb-3 font-Ovo'>Hi! I'm Prathamesh Dabhole <Image src={assets.hand_icon} alt='' className='rounded-full w-6 mb-1'/></motion.h3>
        <motion.h1
        ...
        transition={{duration:0.6, delay: 0.7}}  className='max-w-2xl mx-auto font-Ovo'>Full Stack Developer |BE Computer Engineering Student
at Bharati Vidyapeeth College of Engineering, Lavale, Pune</motion.p>
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            <motion.a
             initial={{y: 30, opacity:0}}
             whileInView={{y: 0, opacity: 1}}
             transition={{duration:0.6, delay: 1.2}} href="/Prathamesh_Resumee.pdf" download className='px-10 py-3 border rounded-full
